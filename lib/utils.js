...
function refreshTestSuiteTab(siteToTest,userIndex){
	...
	fileNameToStoreTraffic = rootOutputPath + fileNameSanitize(siteToTest) + "\\" + (userIndex==0 ? "userA":"userB");
...
exports.saveTrace = function(content)
{
...
exports.log = log;
exports.refreshTestSuiteTab = refreshTestSuiteTab;
