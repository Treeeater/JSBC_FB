...
exports.main = function() {
	...
	pageMod.PageMod({
		include: "*",
		contentScriptFile: [data.url("enroller/jquery-2.0.2.min.js"), data.url("enroller/pressLoginButton.js")],
		contentScriptWhen: 'end',
		onAttach: function(worker) {
	...
	pageMod.PageMod({
		...
		contentScriptFile: [data.url("enroller/jquery-2.0.2.min.js"), data.url("enroller/pressLoginButtonIFrame.js")],
		contentScriptWhen: 'end',
		onAttach: function(worker) {
	...
	pageMod.PageMod({
		include: "*",
		contentScriptFile: [data.url("enroller/jquery-2.0.2.min.js"), data.url("enroller/finishRegistration.js")],
		contentScriptWhen: 'end',
		onAttach: function(worker) {
	...
	pageMod.PageMod({
		include: "https://*",
		contentScriptFile: [data.url("enroller/jquery-2.0.2.min.js"), data.url("enroller/finishRegistrationIFrame.js")],
		contentScriptWhen: 'end',
		onAttach: function(worker) {
